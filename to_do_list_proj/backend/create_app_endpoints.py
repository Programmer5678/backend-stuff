...
@router_main.post("/old", status_code=status.HTTP_201_CREATED)
...
@router_main.get("/main", response_model=GetAllItemsResponse)
...
@router_main.post("/main", status_code=status.HTTP_201_CREATED, response_model=NewItemReturn)

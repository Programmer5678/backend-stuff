...
from scrape_from_spotify import scrape_from_spotify
from main import names_to_link
import time

def search_to_download(songs):
    ...
    with sync_playwright() as p:
        ...
        for song in songs: 
            ...
            page.wait_for_function(" document.querySelectorAll('button').length == 3 ", timeout=80000) # make sure we have 3 buttons before we select based on button order
...
search_to_download( names_to_link(
scrape_from_spotify()
    ) )